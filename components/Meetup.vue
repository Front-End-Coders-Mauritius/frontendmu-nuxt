...
import { CalendarIcon, DotsVerticalIcon, LocationMarkerIcon, XIcon } from '@heroicons/vue/solid'
      ...
      <div class="relative">
        <div class="pt-8 pb-10 md:pt-16 md:pb-24">
          <div class="lg:mx-auto lg:max-w-[1400px] lg:px-4">
            <div class="relative">
              <div aria-hidden="true" class="hidden sm:block lg:inset-y-0 lg:right-0 lg:w-screen">
                ...
                <svg class="absolute top-8 left-1/2 -ml-3 lg:-right-8 lg:left-[54%] lg:top-28" width="404" height="392" fill="none" viewBox="0 0 404 392">
                  <defs>
            ...
            <div class="relative mx-auto max-w-md px-8 py-3 sm:max-w-3xl sm:px-6 md:mx-0 md:py-0">
              <!-- Content area -->
              <div>
                <div class="flex w-full items-center justify-end">
                  <p :class="[isUpcoming ? 'tagStyle bg-yellow-100 text-yellow-800' : 'tagStyle animate-bounce bg-green-100 text-green-800']">
                    {{ isUpcoming ? "past" : "upcoming" }}
                  </p>
                </div>
                <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl lg:text-5xl">
              ...
              <div class="mt-10">
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4 md:gap-y-8">
                  ...
                  <div class="border-y-2 border-gray-100 pt-4 md:pt-6">
                    ...
                    <dd class="flex justify-between rounded-md bg-gray-100 mt-2 px-2 py-1 sm:w-[450px]">
                      <input id="myInput" class="text-md break-words bg-gray-100pr-2 tracking-tight bg-gray-100 text-gray-600 line-clamp-3 w-[500px]" type="text" :value="`https://frontend.mu/event/${meetupId}/`">
                    ...
                    <div class="flex">
                      <button
                        ...
                        "
                      >
                        <icon-facebook-group class="w-14 md:w-16 p-2" />
                      </button>
                      <span>
                  ...
                  <div v-if="props.getCurrentEvent.Attendees" class="md:border-t-2 border-gray-100 pt-4 md:pt-8 flex flex-col justify-center items-center md:items-start gap-4">
                    <dd class="text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
                      <a
          ...
          <div class="lg:mx-auto lg:max-w-[1400px]">
            <div v-if="props.getCurrentEvent.gallery.length > 0" class="images mt-16 px-4 md:mt-48">
              <div class="pb-4 text-center text-4xl font-extrabold text-black md:pb-8 md:text-6xl">Gallery</div>
            ...
            <div v-if="props.getCurrentEvent?.images" class="images mt-16 px-4 md:mt-48">
              <div class="pb-4 text-center text-4xl font-extrabold text-black md:pb-8 md:text-6xl">Gallery</div>
        ...
        <div class="dashboard-button md:-right-17 text-md absolute top-48 -right-16 rotate-90 rounded-b-lg bg-yellow-500 py-2 px-8 font-medium text-white hover:bg-yellow-400 md:py-4 md:text-lg lg:-right-16" @click="open = true">
          View meetups list
        </div>
        <!-- slide-over -->
