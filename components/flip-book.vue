...
@-webkit-keyframes preLoad {
  0% {
    background-image: url("/img/meetupPage1.png");
  }
  10% {
    background-image: url("/img/meetupPage2.png");
  }
  20% {
    background-image: url("/img/meetupPage3.png");
  }
  30% {
    background-image: url("/img/meetupPage4.png");
  }
  40% {
    background-image: url("/img/meetupPage5.png");
  }
  100% {
    display: none;
  }
