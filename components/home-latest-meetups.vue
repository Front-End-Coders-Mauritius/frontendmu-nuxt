...
import { ClockIcon, MenuIcon, TrendingUpIcon, XIcon } from '@heroicons/vue/outline'
...
<template>
  <div class="latest-events-container relative z-20 sm:py-6 md:pt-8 md:px-8 bg-gray-50 px-0">
    <div class="latest-events-wrapper mx-auto px-4 pt-8 md:max-w-3xl md:px-0 lg:max-w-5xl">
      ...
      <div
        class="sm:grid sm:grid-cols-1 gap-8 "
      >
        <template v-for="(event, eventID) in (filteredData as Meetup)" :key="eventID">
