...
<template>
  <div class="homepage-container bg-gray-900">
      ...
      <main class>
        <div class="relative z-0 h-[700px] w-full md:h-[850px]">
          ...
          >
            ...
            >
              <h1
                class="uppercase flex flex-col text-4xl font-extrabold xl:leading-tight text-blue-500 sm:text-5xl lg:text-5xl xl:text-6xl"
              >
                Frontend Coders
...
.image-bg {
  ...
  width: var(--size);
  height: var(--size);
  background-image: linear-gradient(-45deg, #006eff50 50%, #006eff 50%);
  filter: blur(100px);
  transform: translate(-50%, -50%);
