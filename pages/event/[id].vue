        ...
        <div class="mx-auto md:mx-0 relative max-w-md sm:max-w-3xl sm:px-6 px-8 py-3 md:py-0">
          ...
          <div class="mt-10">
            <dl class="grid grid-cols-2 gap-x-4 gap-y-8">
              ...
              <div class="border-t-2 border-gray-100 pt-6" v-if="eventDetails.yes_rsvp_count !== 0">
              ...
              <div class="border-t-2 border-gray-100 pt-6" v-else>
                <dt class="text-base font-medium text-gray-500">Seats available</dt>
                <dd
                  class="text-2xl md:text-3xl font-extrabold tracking-tight text-gray-900"
                >{{ eventDetails.rsvp_limit }}</dd>
              </div>
              <div class="border-t-2 border-gray-100 pt-6">
