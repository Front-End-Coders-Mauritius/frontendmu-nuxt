    ...
    <div class="homepage-wrapper">
      <main class>
        <div class="relative z-0 h-[700px] w-full md:h-[800px]">
          ...
          <div class="relative z-20 mx-auto grid h-full max-w-[700px] place-items-center px-10 text-center">
            <div class="grid gap-10">
              <h1
                ...
                <span class="block text-black xl:inline">Front-End Coders Mauritius</span>
              </h1>
  ...
  <div class="latest-events-container relative z-20 sm:py-6 md:pt-8 md:px-8 px-0">
    <div class="latest-events-wrapper mx-auto px-4 pt-8 md:max-w-3xl md:px-0 lg:max-w-7xl">
      ...
      <div
        ...
        <div v-for="(event, eventID) in filteredData"
          :key="event.title"
          :class="[
            eventID === 0
